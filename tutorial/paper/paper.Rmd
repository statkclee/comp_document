...
```{r fred-data-labor-participation, dev="cairo_pdf", out.width="100%",  eval=FALSE}
library(fredr)
library(xts)
...
```{r labor-share-test, dev="cairo_pdf", out.width="100%", fig.cap="TESTING"}
labor_share <- tribble(~"date",	~"share",
"1948-01-01",	"49.3",
"1949-01-01",	"49.7",
"1950-01-01",	"49.3",
