...
[Ben Marwick, Carl Boettiger, Lincoln Mullen (2018), "Packaging Data Analytical Work Reproducibly
Using R (and Friends)", University of Wollongong
Research Online](https://ro.uow.edu.au/cgi/viewcontent.cgi?article=6445&context=smhpapers)

<br>

![재현가능한 과학연구를 위한 저작 방법](fig/compendium-rrtools.png)

- [`ropensci`, "Community Call: Reproducible Research with R"](https://ropensci.org/commcalls/2019-07-30/)

# R 팩키지와 개요서 [^rrrpkg] [^project-as-packages] {#compendium-intro} 
